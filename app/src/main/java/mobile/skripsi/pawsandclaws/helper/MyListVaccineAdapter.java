...
/**
 * My List Vaccine Adapter
 * Created by @lukmanadelt on 12/8/2017.
 */

public class MyListVaccineAdapter extends BaseExpandableListAdapter {
    private Context context;
    private ArrayList<HeaderInfo> deptList;

    public MyListVaccineAdapter(Context context, ArrayList<HeaderInfo> deptList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (view == null) {
            ...
            if (infalInflater != null)
                view = infalInflater.inflate(R.layout.child_row_vaccine, parent, false);
        }
